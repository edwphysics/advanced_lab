...
* Infer the Pantheon+ parameters
* Use model_comparte. Take care of twhere you are sending/saving the chains.
	- Send first the model you want to compare against the others.
